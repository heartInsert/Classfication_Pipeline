...
if __name__ == "__main__":
    ...
    config_path = r'/home/xjz/Desktop/Coding/PycharmProjects/competition/kaggle/cassava_leaf_disease_classification/configs/efficientnetb3Ranger_labelsmooth.py'
